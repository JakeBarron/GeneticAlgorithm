 ...
 * @version  04/05/2018
	class Chromosome
            class to hold that holds amino acid data and methods to fold
            crossover and mate
**/
...
public class Chromosome implements Comparable<Chromosome> {
    ...
    private int fitness;
    //4 arrays to hold x,y coordinates, protein color, and fold directions
    private int[] X;
    private int[] Y;
    ...
    /*
    base constructor takes a string sequence of h(black) and p(white) 
     proteins*/
    ...
    /*Method to give chromosome initial legal structure and then calls 
        compute fitness folds protein randomly
    */
    ...
    /*
        validate
        @returns isValid whether or not the structure is legal that is it has
        no two proteins with the same coordinates
    */
  ...
  /*
    Crossover
    @returns a new  valid chromosome that is the result of crossing two 
    chromosomes at a random fixed point
*/
    ...
    /*
        mutate method to simulate mutating a chromosome.  Rotates section of
        chromosome at a random fixed point
        @returns this chromosome object reoriented about a random fixed point
    */
    ...
    /*
        This method prints a text version of this chromosome for testing
        purposes
    */
    ...
    /*
        natural order of chromosome is based on |fitness| used to determine
        which of two chromosomes is more fit
        @returns an integer that is positive if this chromosome is more fit
        negative if this chromosome is more fit and 0 if they are equal
    */
